...
Each cycle tracks the first 46 cm in steps of up to 10 cm, then advances the
final 14 cm without vision at a requested 0.7 m/s, grips and lifts 30 mm,
...
tracked 10 cm forward step. The first 46 cm are tracked; once 46 cm has been
commanded, it drives the final 14 cm and grips without another camera check.
The last visual check occurs before the step from 40 to 46 cm, since the tag
may already be hidden at the 46 cm boundary. It shifts sideways 3 cm at a time
...
Place each tag at the holder's centre and keep it visible until the last 14 cm.
